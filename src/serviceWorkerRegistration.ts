  ...
  try {
    ...
    if (
      ...
      try {
        ...
        console.error('Error on serviceWorkerReady : ', error)
      }
    } else {
...
export function register(config?: Config): void {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    const loadEventFunction = async (): Promise<void> => {
    ...
    window.addEventListener('load', () => {loadEventFunction().catch(console.error)})
  }
}
